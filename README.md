...
**Projeto Final - Programação Orientada a Objetos (POO)** **UTFPR - Campus Santa Helena** **Ano:** 2025  
...
Passo a Passo
Configurar Banco de Dados: Execute o script SQL no seu gerenciador MySQL para criar o banco e tabelas:
...
Abra o projeto no NetBeans (File > Open Project).
...
Execute o arquivo principal ou a tela de login (FrmLogin.java).
